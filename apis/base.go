...
func NewRouter(app core.App) (*router.Router[*core.RequestEvent], error) {
	...
	// register identity cache invalidation hooks
	RegisterIdentityCacheHooks(app)
	...
	bindGraphqlApi(app, apiGroup)
	bindSQLApi(app, apiGroup)
	bindLogsApi(app, apiGroup)
	bindBackupApi(app, apiGroup)
	bindCronApi(app, apiGroup)
	bindActivationApi(app, apiGroup)
	bindFileApi(app, apiGroup)
	bindBatchApi(app, apiGroup)
	bindRealtimeApi(app, apiGroup)
	bindHealthApi(app, apiGroup)
	bindVectorApi(app, apiGroup)
	bindLLMDocumentApi(app, apiGroup)
	bindLangchaingoApi(app, apiGroup)
	bindPubSubApi(app, apiGroup)
	bindCacheApi(app, apiGroup)
	bindScriptPermissionsApi(app, apiGroup)
	bindScriptsApi(app, apiGroup)
	bindRedisApi(app, apiGroup)
