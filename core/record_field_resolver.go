...
// DriverName returns the database driver name used by the resolver's app.
// This method allows search providers to use driver-aware expressions.
func (r *RecordFieldResolver) DriverName() string {
	if r.app != nil {
		return BuilderDriverName(r.app.NonconcurrentDB())
	}
	return ""
}
