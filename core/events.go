...
import (
	...
	"github.com/bosbase/bosbase-enterprise/tools/auth"
...
type RecordBindTokenRequestEvent struct {
	hook.Event
	*RequestEvent
	baseCollectionEventData
...
type RecordUnbindTokenRequestEvent struct {
	hook.Event
	*RequestEvent
	baseCollectionEventData
...
type RecordAuthWithTokenRequestEvent struct {
	hook.Event
	*RequestEvent
	baseCollectionEventData
