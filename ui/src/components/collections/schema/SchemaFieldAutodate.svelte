<script>
    ...
    const options = [
        { label: $_("common.placeholder.atCreate"), value: ON_CREATE },
        { label: $_("common.placeholder.atUpdate"), value: ON_UPDATE },
        { label: $_("common.placeholder.atCreateOrUpdate"), value: ON_CREATE_UPDATE },
    ];
...
<SchemaField bind:field {key} on:rename on:remove on:duplicate {...$$restProps}>
    <svelte:fragment let:interactive>
        ...
        <Field
            ...
            let:uniqueId
        >
            <div use:tooltip={{ text: $_('common.tip.autoGeneratedTime'), position: "top" }}>
                <ObjectSelect
                    id={uniqueId}
                    items={options}
