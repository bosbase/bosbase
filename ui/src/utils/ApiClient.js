import BosBase, { LocalAuthStore, isTokenExpired } from "bosbase";
// ---
 ...
 */
BosBase.prototype.logout = function (redirect = true) {
 ...
 */
BosBase.prototype.error = function (err, notify = true, defaultMsg = "") {
 ...
 */
BosBase.prototype.getSuperuserFileToken = async function (collectionId = "") {
    let needToken = true;
...
const pb = new BosBase(pbUrl, new AppAuthStore());
