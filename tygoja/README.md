...
For a more detailed example you can also explore the [PocketBase's jsvm plugin](https://github.com/bosbase/bosbase-enterprise/tree/develop/plugins/jsvm/internal/docs).
