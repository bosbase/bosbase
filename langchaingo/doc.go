...
//
//   - [langchaingo/llms]: Interfaces and implementations for various language models (OpenAI, Anthropic, Google, etc.)
//   - [langchaingo/chains]: Composable operations that can be linked together to create complex workflows
//   - [langchaingo/agents]: Autonomous entities that can use tools to accomplish tasks
//   - [langchaingo/embeddings]: Text embedding functionality for semantic search and similarity
//   - [langchaingo/vectorstores]: Interfaces to vector databases for storing and querying embeddings
//   - [langchaingo/memory]: Conversation history and context management
//   - [langchaingo/tools]: External tool integrations (web search, calculators, databases, etc.)
//
// # Quick Start
//
...
//		"langchaingo/schema"
//		"langchaingo/vectorstores/chroma"
//	)
//
//	// Create an embedder
...
//	import (
//		"langchaingo/agents"
//		"langchaingo/tools/serpapi"
//		"langchaingo/tools/calculator"
//	)
//
//	// Create tools
...
//
//	import "langchaingo/internal/httprr"
//
