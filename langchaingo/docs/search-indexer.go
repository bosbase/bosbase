...
func parseFlags() Config {
	...
	flag.StringVar(&config.PkgGoDevURL, "pkg-url", "https://pkg.go.dev/langchaingo", "pkg.go.dev base URL")
	flag.StringVar(&config.ModulePath, "module", "langchaingo", "Go module path")
